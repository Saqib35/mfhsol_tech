              ...
              $.ajax({
                ...
                success: function(response) {
                    ...
                    if(response.success==true){
                        toastr.success('Extra Category Deleted Successfully', 'success');
