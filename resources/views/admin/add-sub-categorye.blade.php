                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Extra Category Details</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('panel/admin/add-extra-sub-categorye') }}" enctype='multipart/form-data' method="post" class="drozone">
                                @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="productname">Select Sub Category</label>
                                            <select class="form-control" name="sub_cate_slug">
                                                @foreach($subCategories as $subCategories)
                                                <option value="{{$subCategories['slug']}}"> {{$subCategories['category_slug']}} ---- {{$subCategories['sub_cate_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="sub_cate_name">Extra Category Name</label>
                                    ...
                                    <!-- <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="sub_cate_img">Extra Category Img</label>
