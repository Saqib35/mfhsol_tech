    <footer class="footer-wrapper footer-layout2" data-bg-src="assets/img/bg/footer-bg-2-1.jpg">
                ...
                <div class="row align-items-center justify-content-between gy-30">
                    <div class="col-sm-auto">
                        <div class="footer-top-logo">
                            <a href="index.php"><img src="assets/img/logo-white.png" alt="TechBiz" class="logo"></a>
                        </div>
                    </div>
                    <div class="col-sm-auto">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-auto order-3">
                        <div class="widget footer-widget">
                            ...
                            <div class="footer-number">
                                ...
                                <a href="tel:+248215621532" class="info">+(248) 2156-21532</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2022 <a class="text-white" href="index.php">TechBiz</a>. All rights reserved by <a class="text-white" href="https://themeforest.net/user/vecuro_themes">Vecuro</a>.</p>
            </div>
        </div>
    </footer>
    <!-- Scroll To Top -->
